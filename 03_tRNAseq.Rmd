...
```{r}
info= read.delim("only_read2_LNCaP_tRNA_raw_counts.txt", header=T, stringsAsFactors = F, row.names = 1)
info = info[, c(1:3)]


tag = "LNCAP_LP_VS_AD"
df = read.delim("LNCaP_isodecoders_cpm.txt" , header=T, stringsAsFactors = F, row.names=1)
