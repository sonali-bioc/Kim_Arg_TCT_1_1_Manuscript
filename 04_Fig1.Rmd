...
# Fig_1a
```{r}
LNCaP_isoacceptor <- read.xlsx("Figures for Manuscript/Rscripts/Supplementary_Table_1.xlsx", sheetIndex = 1, header = TRUE)
...
# Fig 1c
```{r}
LNCaP_isodecoder <- read.xlsx("Figures for Manuscript/Rscripts/Supplementary_Table_1.xlsx", sheetIndex = 3, header = TRUE)
...
# Fig_1e
```{r}
Cell_line_data <- read_csv("Figures for Manuscript/Rscripts/Fig_1e+f.csv")
...
# Fig_1K
```{r}
TMA_RISH <- read_csv("Figures for Manuscript/Rscripts/Fig_1k.csv")
TMA_RISH <- TMA_RISH %>%
...
# Fig_1l
```{r}
Patient_scores <- read.xlsx("Figures for Manuscript/Rscripts/Fig_1l.xlsx", sheetIndex = 1, header = TRUE)
